        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              // Backend field names: image/imageUrl, btnText/buttonText, btnHref/buttonUrl
              final imageUrl = AppConfig.resolveMediaUrl(
                slide['image'] as String? ?? slide['imageUrl'] as String? ?? '');
              final btnText = slide['btnText'] as String? ?? slide['buttonText'] as String?;
              final btnUrl = slide['btnHref'] as String? ?? slide['buttonUrl'] as String? ?? '';
              return Stack(
                fit: StackFit.expand,
                children: [
                  imageUrl.isNotEmpty
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (btnText != null) ...[
                          ...
                          ElevatedButton(
                            onPressed: () {
                              if (btnUrl.startsWith('/')) context.go(btnUrl);
                              else if (btnUrl.isNotEmpty) launchUrl(Uri.parse(btnUrl));
                            },
                            child: Text(btnText),
                          ),
                        ],
